...
cJSON * opendoorcmd_to_app()
{
	...
	string = cJSON_CreateString("rtsp://192.168.1.137:554/ch01_sub.h264");
	cJSON_AddItemToObject(param_obj,"video",string);
	string = cJSON_CreateString("rtmp://192.168.1.137:1935/live");
	cJSON_AddItemToObject(param_obj,"audio",string);
	cJSON_AddItemToObject(result_root,"param",param_obj);
